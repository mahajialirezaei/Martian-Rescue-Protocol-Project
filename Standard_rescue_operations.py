def get_input():
    ...
    Capacity_Residential_Area = list(map(int, input('Number of Capacity Residential Area :').split(' ')))
    Time_Texas_Space_Stations = list(map(int, input('Number of Time Texas Space Stations :').split(' ')))
...
ship, B, C, Passengers_Groups, Capacity_Residential_Area, Time_Texas_Space_Stations, Time_of_Traveling = get_input()
